...
4. Write a new session file at `journal/ops/sessions/<nickname>-<timestamp>.md`.
...
9. Update `journal/ops/tasks.md` with in-progress, active, and done items.
10. Append one line to `journal/log.md`.
