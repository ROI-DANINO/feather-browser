...
```bash
bash .claude/plugins/claude-council/scripts/query-council.sh --list-default 2>&1 | head -1
```
...
```bash
bash .claude/plugins/claude-council/scripts/lib/export.sh --write "<output_path>" "<prompt>" "<providers>"
```
