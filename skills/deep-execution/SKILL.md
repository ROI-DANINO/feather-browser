...
- Provider name and script path: `.claude/plugins/claude-council/scripts/providers/{name}.sh`
- Model name: run `bash .claude/plugins/claude-council/scripts/query-council.sh --list-available` or read the provider script defaults
